...
describe('Blog testing', () => {
    ...
    it('should create two new blogs', async () => {
        ...
        expect(blogCreate2.statusCode).toEqual(201)
        expect(blogCreate2.body.title).toBe('Ask me how I know')
    })
    ...
    it('should create two additional blogs', async () => {
        const blogCreate = await agent
            .post(`/api/blog`)
            .send({
        ...
        expect(blogCreate.statusCode).toEqual(201)
        expect(blogCreate.body.title).toBe('The sky is blue')
        expect(blogCreate2.statusCode).toEqual(201)
        expect(blogCreate2.body.title).toBe('So many things')
    })
    it('should logout a user', async () => {
        const userLogout = await agent
            .post('/api/logout')
